export function createOscilloscopeView() {
    ...
    container.innerHTML = `
        ...
        <div class="osc-toolbar">
            ...
            <button class="osc-btn" title="Масштаб">
            ...
            <button class="osc-btn" title="Измерение временных интервалов">
                <svg viewBox="0 0 24 24"><path fill="currentColor" d="M22 12l-4-4v3H6V8L2 12l4 4v-3h12v3l4-4z"/></svg>
            </button>
            <button class="osc-btn" title="Измерение амплитуды сигнала">
                <svg viewBox="0 0 24 24"><path fill="currentColor" d="M12 2L8 6h3v12H8l4 4 4-4h-3V6h3l-4-4z"/></svg>
            </button>
        </div>

        <!-- ОСНОВНАЯ РАБОЧАЯ ОБЛАСТЬ (левая таблица + правые графики) -->
