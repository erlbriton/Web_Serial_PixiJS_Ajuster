...
export function createOscilloscopeView(): HTMLElement {
        ...
        <div class="osc-main-area">
            <div class="osc-table-wrapper" id="osc-left-panel">
                <table class="osc-data-grid">
                    ...
                    <thead>
                        <tr><th>Name</th><th>Hex</th><th>Physical</th><th>Unit</th></tr>
                    </thead>
    ...
    panelSplitter.addEventListener('mousedown', (e: Event) => {
        ...
        const doPanelDrag = (moveEvent: MouseEvent) => {
            let delta = moveEvent.clientX - startX;
            finalWidth = Math.max(200, startWidth + delta);
    ...
    headers.forEach((th, idx) => {
        ...
        resizer.addEventListener('mousedown', (e: Event) => {
            ...
            const doColDrag = (moveEvent: MouseEvent) => {
                let delta = moveEvent.clientX - startX;
                // Ограничения минимальной ширины 40px
